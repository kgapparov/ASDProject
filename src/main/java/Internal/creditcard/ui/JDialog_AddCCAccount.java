...
public class JDialog_AddCCAccount extends javax.swing.JDialog
{
	...
	public JDialog_AddCCAccount(CardFrm parent, CustomerType customerType)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       if (JRadioButton_Gold.isSelected())
		   ...
		   //createCustomer
		   parentframe.getInvoker().setCommand(0, new CardCustomerCreateCommand(parentframe.getAccountService(),customerType));
