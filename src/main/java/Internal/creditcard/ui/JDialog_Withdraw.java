...
import Internal.framework.controller.commands.WidthdrawCommand;
...
public class JDialog_Withdraw extends JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		parentframe.getInvoker().setCommand(1, new WidthdrawCommand(parentframe.getAccountService()));
		parentframe.getInvoker().getCommand(1).setParams(parentframe.ccnumber,parentframe.amountDeposit);
		parentframe.getInvoker().getCommand(1).execute();
		dispose();
	}
