...
public class JDialog_Withdraw extends JDialog
{
	...
	public JDialog_Withdraw(ApplicationFrm parent, String aaccnr)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		if (parentframe.accountnr != null) {
			parentframe.getAccountService().withdraw(parentframe.accountnr, Double.parseDouble(parentframe.amountDeposit));
		}
		dispose();
	}
